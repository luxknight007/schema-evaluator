/*
*   Created by Zoilo Dela Cruz and John Aspen Catingub
...
module.exports = (function() {
    ...
    function setRecursiveObjects(schemaObject, jsonObject, keyProperty) {
        ...
        if (recursedObject.properties[keyProperty]['type'] === "array") {
            recursedObject.properties[keyProperty]['items'] = generate_schema(jsonObject[keyProperty][0]);
        }

        //If Type is an object, add items property,
        if (recursedObject.properties[keyProperty]['type'] === "object") {
            recursedObject.properties[keyProperty] = generate_schema(jsonObject[keyProperty]);
        }
    ...
    function generate_schema(object) {
            var schemaObject = {};
